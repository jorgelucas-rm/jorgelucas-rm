...
Linguagens & Tecnologias: `Python`, `FastAPI`, `Java`, `Spring` e `GoLang`.\
Período: `jun/2024` - `dez/2024`
<br/>

[<img align="left" height="94px" width="94px" alt="Warpnet" src="assets/centz.png"/>](https://centz.com.br/)
**Desenvolvedor Backend** \
[**Centz**](https://centz.com.br/) • Estágio \
Linguagens & Tecnologias: `Python`, `FastAPI`, `Javascript`, `Node.js` e `PostgreSQL`.\
Período: `jan/2024` - `atual`
